...
pub(crate) struct XcbShmShm {
    ...
    xcb_shm_seg_next: LazySymbol<unsafe extern "C" fn(i: *mut xcb_shm_seg_iterator_t)>,
    xcb_shm_seg_end:
        LazySymbol<unsafe extern "C" fn(i: xcb_shm_seg_iterator_t) -> xcb_generic_iterator_t>,
    xcb_shm_query_version: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_shm_query_version_cookie_t,
    >,
    xcb_shm_query_version_unchecked: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_shm_query_version_cookie_t,
    >,
    ...
    >,
    xcb_shm_detach_checked: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t, shmseg: xcb_shm_seg_t) -> xcb_void_cookie_t,
    >,
    xcb_shm_detach: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t, shmseg: xcb_shm_seg_t) -> xcb_void_cookie_t,
    >,
