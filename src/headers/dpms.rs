...
pub(crate) struct XcbDpmsDpms {
    ...
    >,
    xcb_dpms_capable:
        LazySymbol<unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_dpms_capable_cookie_t>,
    ...
    >,
    xcb_dpms_get_timeouts: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_dpms_get_timeouts_cookie_t,
    >,
    xcb_dpms_get_timeouts_unchecked: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_dpms_get_timeouts_cookie_t,
    >,
    ...
    xcb_dpms_disable:
        LazySymbol<unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_void_cookie_t>,
    xcb_dpms_force_level_checked: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t, power_level: u16) -> xcb_void_cookie_t,
    >,
    xcb_dpms_force_level: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t, power_level: u16) -> xcb_void_cookie_t,
    >,
    xcb_dpms_info:
        LazySymbol<unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_dpms_info_cookie_t>,
