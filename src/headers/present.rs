...
pub(crate) struct XcbPresentPresent {
    ...
    xcb_present_notify_next:
        LazySymbol<unsafe extern "C" fn(i: *mut xcb_present_notify_iterator_t)>,
    xcb_present_notify_end: LazySymbol<
        unsafe extern "C" fn(i: xcb_present_notify_iterator_t) -> xcb_generic_iterator_t,
    >,
    ...
    xcb_present_pixmap_sizeof:
        LazySymbol<unsafe extern "C" fn(_buffer: *const c_void, notifies_len: u32) -> c_int>,
    ...
    >,
    xcb_present_pixmap_notifies: LazySymbol<
        unsafe extern "C" fn(r: *const xcb_present_pixmap_request_t) -> *mut xcb_present_notify_t,
    >,
    xcb_present_pixmap_notifies_length:
        LazySymbol<unsafe extern "C" fn(r: *const xcb_present_pixmap_request_t) -> c_int>,
    ...
    >,
    xcb_present_event_next: LazySymbol<unsafe extern "C" fn(i: *mut xcb_present_event_iterator_t)>,
    xcb_present_event_end:
        LazySymbol<unsafe extern "C" fn(i: xcb_present_event_iterator_t) -> xcb_generic_iterator_t>,
    ...
    xcb_present_redirect_notify_notifies_length:
        LazySymbol<unsafe extern "C" fn(r: *const xcb_present_redirect_notify_event_t) -> c_int>,
