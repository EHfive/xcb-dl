...
pub(crate) struct XcbXineramaXinerama {
    ...
    xcb_xinerama_screen_info_next:
        LazySymbol<unsafe extern "C" fn(i: *mut xcb_xinerama_screen_info_iterator_t)>,
    xcb_xinerama_screen_info_end: LazySymbol<
        unsafe extern "C" fn(i: xcb_xinerama_screen_info_iterator_t) -> xcb_generic_iterator_t,
    >,
    ...
    >,
    xcb_xinerama_is_active: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_xinerama_is_active_cookie_t,
    >,
    xcb_xinerama_is_active_unchecked: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_xinerama_is_active_cookie_t,
    >,
    ...
    xcb_xinerama_query_screens: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_xinerama_query_screens_cookie_t,
    >,
    xcb_xinerama_query_screens_unchecked: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t) -> xcb_xinerama_query_screens_cookie_t,
    >,
    ...
    xcb_xinerama_query_screens_screen_info_length:
        LazySymbol<unsafe extern "C" fn(r: *const xcb_xinerama_query_screens_reply_t) -> c_int>,
