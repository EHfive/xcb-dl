...
pub(crate) struct XcbXevieXevie {
    ...
    >,
    xcb_xevie_start: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t, screen: u32) -> xcb_xevie_start_cookie_t,
    >,
    xcb_xevie_start_unchecked: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t, screen: u32) -> xcb_xevie_start_cookie_t,
    >,
    ...
    >,
    xcb_xevie_end: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t, cmap: u32) -> xcb_xevie_end_cookie_t,
    >,
    xcb_xevie_end_unchecked: LazySymbol<
        unsafe extern "C" fn(c: *mut xcb_connection_t, cmap: u32) -> xcb_xevie_end_cookie_t,
    >,
    ...
    >,
    xcb_xevie_event_next: LazySymbol<unsafe extern "C" fn(i: *mut xcb_xevie_event_iterator_t)>,
    xcb_xevie_event_end:
        LazySymbol<unsafe extern "C" fn(i: xcb_xevie_event_iterator_t) -> xcb_generic_iterator_t>,
